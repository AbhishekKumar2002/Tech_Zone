  ...
  return (
    ...
    <div className='w-full max-w-md bg-white m-auto flex items-center flex-col p-4'>
      ...
      <form className='w-full py-3 flex flex-col' action="" onSubmit={handleSubmit}>
        ...
        <input type={"text"} id='firstname' name='firstname' className='w-full bg-slate-200 px-2 py-1 rounded mt-1  mb-2 focus-within:outline-blue-300' value = {data.firstname} onChange={handleOnChange} />
        <label htmlFor='lastName'>Last Name</label>
        <input type={"text"} id='lastname' name='lastname' className='w-full bg-slate-200 px-2 py-1 rounded mt-1 mb-2 focus-within:outline-blue-300 ' value = {data.lastname} onChange={handleOnChange} />
        <label htmlFor='email'>E-Mail</label>
        <input type={"email"} id='email' name='email' className='w-full bg-slate-200 px-2 py-1 rounded mt-1 mb-2 focus-within:outline-blue-300' value = {data.email} onChange={handleOnChange} />
